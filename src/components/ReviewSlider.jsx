      ...
      <div className={`review-slider ${addClass}`}>
        <div className="review-slider-counter">
          <svg width={50} height={50} fill="none"
            ...
            <circle ref={circle} cx={25} cy={25} r={24} stroke="#fff"
                    strokeWidth={1}
                    fill="transparent" />
          </svg>
          {/* eslint-disable-next-line jsx-a11y/no-static-element-interactions */}
          <div onClick={() => currentSlider.slickNext()}
               className="review-slider-counter-next">
            <svg width={22} height={18} viewBox="0 0 22 18" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
              <path d="M0 9H20M20 9L12.3404 1M20 9L12.3404 17" stroke="white"
                    strokeWidth={2} />
            </svg>
          </div>
        </div>
          ...
          {slides?.map((slide, index) => {
            ...
            return (
              <React.Fragment key={index}>
                {/* eslint-disable-next-line jsx-a11y/no-static-element-interactions */}
                <div onClick={() => setActiveCompany(refCompanies)}
